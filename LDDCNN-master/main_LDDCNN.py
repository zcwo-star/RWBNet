...
data_dir = '/path/to/weld_seam/dataset'  # Update to your weld seam dataset path
address = 'last'  # Test the last trained network

################################################################################
# Network parameters (Adapted for LDDCNN)
################################################################################
net_class = sn.LDDCNN  # Assuming LDDCNN is defined in src.networks
net_params = {
    ...
    'kernel_size': 3,    # Standard kernel size for denoising
...
dataset_params = {
    'data_dir': data_dir,  # Directory with noisy weld seam images
...
train_params = {
    ...
    'optimizer': {
        'lr': 0.001,         # Lower learning rate for image tasks
        'weight_decay': 1e-4,
        'amsgrad': True,
    },
    ...
    'loss': {
        ...
        'perceptual_weight': 0.1,  # Optional perceptual loss weight
    },
